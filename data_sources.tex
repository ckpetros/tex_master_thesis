...
\begin{tabular}{l|l|l}
\hline
\rowcolor{white} % not lightgray
\textbf{Column}         & \textbf{Description}                                                                                                        & \textbf{Values}              \\ \hline\hline
...
\hline
\rowcolor{white}
\textbf{Column}           & \textbf{Description}                                   & \textbf{Values (all Factors)}                 \\ \hline\hline
